...
| 장 마감 후 갱신 | 평일 16:10 | 그날 종가로 예측을 **채점**하고 보고서를 다시 발행합니다. 새 예측은 원장에 **기록하지 않습니다** — 오후에는 그날 밤 미국 장 정보가 없어 아침 예측보다 정보가 적은데, 원장은 날짜별 최초 사전 예측만 집계하므로 기록하면 정보가 적은 쪽이 채택되기 때문입니다. 보고서에도 "장 마감 후 갱신" 안내가 붙습니다. |
