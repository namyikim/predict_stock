...
- [ ] **Step 4: 예측 불변성·채점·집계의 실패 테스트 작성**
...
- [ ] **Step 1: 세 번째 탭과 데이터 분리의 실패 테스트 작성**
...
- [ ] **Step 6: JavaScript 구문과 탭 회귀 테스트 실행**
...
- [ ] **Step 1: GitHub 연결을 읽기 전용 호출로 확인**
