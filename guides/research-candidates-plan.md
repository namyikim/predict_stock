...
| R09 | [~] | 선행지수 2~3개월 전망(ARIMA·VAR), 다음 분기 이익 모형에 반영 | 0단계(판본 보관)가 먼저 | 0·1·2단계 완료(2026-09-12). **채택 없음** — ARIMA·VAR 모두 기준선에 동률 이하, VAR 은 세 지평 모두 열위. 1개월에서 기준선 drift 만 rw 를 이긴다. 3단계는 조건 미충족으로 미실행. 판본 보관은 켰다 |
