...
| R08 | [~] | 미국 이벤트 일정 확장 → 이벤트일 구간·보류 정책 | 1·2단계는 없음, 3단계는 R01 | 1단계 완료(2026-09-12): FOMC 8회·고용보고서 12회·PCE 4회 추가, 24→48건. 2·3단계 미실행 |
...
- 2026-09-12 실행: R07 채택 없음(`experiments/medium_horizon/R07/decision.md`), R08 1단계 완료(FOMC 8회·고용보고서 12회·PCE 4회, 24→48건).
  R08 2단계(이벤트일/평일 채점 분리)는 표시가 쌓인 뒤에 한다. 3단계(구간·보류 정책)는 R01 뒤다.
