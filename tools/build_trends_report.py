...
def build_html(items, geo, now):
    ...
    return (
        ...
        f'<div class="page-title" style="font-size:11px;letter-spacing:2px;color:#8a9199">GOOGLE TRENDS · {e(geo)}</div>'
        '<h2 class="page-title" style="margin:6px 0 5px;font-size:27px">인기 급상승 검색어</h2>'
